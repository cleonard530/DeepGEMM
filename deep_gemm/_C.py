...
_bind_guarded_ops(
    ...
    'get_ring_limit_for_mega_moe',
)


def fp8_fp4_mega_moe(y, l1_weights, l2_weights, cumulative_local_expert_recv_stats, sym_buffer,
                     sym_buffer_ptrs, rank_idx, num_max_tokens_per_rank, num_experts, num_topk, recipe,
                     activation, activation_clamp, fast_math, num_ring_tokens):
    return _torch_ops.fp8_fp4_mega_moe(
        ...
        activation_clamp, fast_math, num_ring_tokens,
    )


def bf16_mega_moe(y, l1_weights, l2_weights, cumulative_local_expert_recv_stats, sym_buffer,
                  sym_buffer_ptrs, rank_idx, num_max_tokens_per_rank, num_experts, num_topk,
                  activation, activation_clamp, fast_math, num_ring_tokens):
    return _torch_ops.bf16_mega_moe(
        y, l1_weights, l2_weights, cumulative_local_expert_recv_stats, sym_buffer,
