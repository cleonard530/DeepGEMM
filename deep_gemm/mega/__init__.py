...
def fp8_fp4_mega_moe(y: torch.Tensor,
                     ...
                     shared_l1_weights_tuple_opt: Optional[Tuple[torch.Tensor, torch.Tensor]] = None,
                     shared_l2_weights_tuple_opt: Optional[Tuple[torch.Tensor, torch.Tensor]] = None,
                     cumulative_local_expert_recv_stats: Optional[torch.Tensor] = None,
                     recipe: Tuple[int, int, int] = (1, 1, 32),
                     activation: str = 'swiglu',
                     activation_clamp_opt: Optional[float] = None,
                     fast_math: bool = True,
                     situ_beta: Optional[float] = None,
                     situ_linear_beta: Optional[float] = None):
    _C.fp8_fp4_mega_moe(
        y,
        l1_weights_tuple, l2_weights_tuple,
        ...
        recipe,
        activation, activation_clamp_opt,
        fast_math,
...
def bf16_mega_moe(y: torch.Tensor,
                  ...
                  sym_buffer: SymmBuffer,
                  shared_l1_weights_opt: Optional[torch.Tensor] = None,
                  shared_l2_weights_opt: Optional[torch.Tensor] = None,
                  cumulative_local_expert_recv_stats: Optional[torch.Tensor] = None,
                  activation: str = 'swiglu',
                  activation_clamp_opt: Optional[float] = None,
                  fast_math: bool = True):
